...
<div class="content" id="select-house-content">
	...
	<div class="feedback_btn">
		<a href="<%=request.getContextPath()%>/yjfk.action?url=<%=java.net.URLEncoder.encode(sbi.xwb.weixin.commons.filemonitor.PropertiesReader.read("server")+request.getContextPath()+"/admin/index.action?lm=fy","UTF-8") %>"></a>
		</div>
    <!--意见反馈-->
  ...
  <script>
    ...
    var houseMsgUrl = "${pageContext.request.contextPath}/admin/msglist.action";
	var searchUrl = '${pageContext.request.contextPath}/admin/lc/search.action';
