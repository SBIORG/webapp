        ...
        <form class='meterForm' method="post" action="${pageContext.request.contextPath}/admin/metersubmit.action">
           ...
           <div class="each_box">          
              ...
              <div class="clearfix each_info">             
                 <input type="text" class="write_meter_num" name="meter[${meter.meter_id}][meter_num]" placeholder="本月表数：">                 <div>             
                 <textarea class="write_meter_txt" name="meter[${meter.meter_id}][remark]" placeholder="输入备注..."></textarea>                 </div>            
