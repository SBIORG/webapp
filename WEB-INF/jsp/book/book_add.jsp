...
<div class="content" id="select-house-content">
	...
	<a href="<%=request.getContextPath()%>/yjfk.action?url=<%=java.net.URLEncoder.encode(sbi.xwb.weixin.commons.filemonitor.PropertiesReader.read("server")+request.getContextPath()+"/list.action?lm=yw","UTF-8") %>"></a>
	</div>
    <!--意见反馈-->
