...
<body>
  ...
  <div class="content">
      ...
      <div class="feedback_btn">
       <a href="<%=request.getContextPath()%>/yjfk.jsp?url=<%=request.getHeader("Referer")%>"></a>
      </div>
      <!--意见反馈-->

    <!--留言返回按钮-->
    <div class="message_goback">
      <a href="${pageContext.request.contextPath}/index.jsp?lm=fy"> < <span>${param.houseNO}</span> 留言</a>
    </div>
    <!--留言返回按钮-->
