        ...
        <div class="each_box">
          <div class="clearfix each_info">
            ...
            <div class="meter_box clearfix">
               <iframe id="uploadIframe" scrolling="no" style="width:100%;" src="<%=sbi.xwb.weixin.commons.filemonitor.PropertiesReader.read("domain") %>/weixin/file/index?user_id=${userInfo.user_id}"></iframe>
            </div>
          </div>
        </div>
        <!--填写反馈-->
